        ...
        <section className="flex flex-col gap-6">
          {userStore.username == username ? (
            <div className=" hidden sm:flex  gap-6 ">
              <span className="text-lg py-1 font-medium px-2">
                {user.username}
              </span>
            ...
            <div className=" hidden sm:flex  gap-6 ">
              <span className="text-lg py-1 font-medium px-4">
                {user.username}
              </span>
              <FollowUnfollwBtn
                targetUser={user}
            ...
            allUserPosts.map((post) => {
              if (post.mediaType === "video")
                return (
                  <div
                    onClick={() => {
                      const index = allUserPosts.findIndex(
                        (posts) => posts._id === post._id
                      );
            ...
            userReels.map((post) => {
              if (post.mediaType === "video")
                return (
                  <div
                    onClick={() => {
                      const index = userReels.findIndex(
                        (posts) => posts._id === post._id
                      );
            ...
            userSavedPosts.map((post) => {
              if (post.mediaType === "video")
                return (
                  <div
                    onClick={() => {
                      const index = userSavedPosts.findIndex(
                        (posts) => posts._id === post._id
                      );
